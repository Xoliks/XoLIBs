...
execute unless function xolibs:playerdata/sub/test run return fail
...
function xolibs:playerdata/sub/save with storage xolibs:playerdata temp.save
...
function xolibs:playerdata/sub/get with storage xolibs:playerdata temp.load
