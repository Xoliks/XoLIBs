...
execute if data storage xolibs:temp enumerate{"character":'"'} if function xolibs:enumerate/compound_to_array/character_loop/backslash_test run return run scoreboard players add character_index xolibs.temp 1
...
function xolibs:enumerate/compound_to_array/character_loop/double_quote_loop