...
execute if data storage xolibs:temp string_concatenate{character:"'"} run function xolibs:string/concatenate/add_single_quote with storage xolibs:temp string_concatenate
...
#combine strings
function xolibs:string/concatenate/double_quote_combine with storage xolibs:temp string_concatenate
